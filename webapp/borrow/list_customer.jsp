		...
		<tbody>
			<tr valign="top">
				...
				<td width="730">
					...
					<form action="<%=basePath%>/api?servlet=borrow&cmd=list"
										...
										<tbody>
											<tr>
												<td width="210" valign="top" height="23"
													...
													class="zi-leibie1"><strong>订阅情况</strong>
												</td>
												<td width="210" valign="top" height="23"
													style="PADDING-left:12px;PADDING-top:6px;"
															...
															<tr>
																...
																<td><div align="center">
																		<img width="110" height="110" border="0"
																			src="<%=basePath%>/images/book/<%=borrow.getBook_img()%>">
																	</div>
																</td>
																<%
																	}
														...
														<tbody>
															<tr>
																...
																<td width="65"><div align="center">
																		<a
																			href="<%=basePath%>/api?servlet=borrow&cmd=prepare_upd&info=1&id=<%=borrow.getId()%>"><img
																...
																<td width="65"><div align="center">
																		<a
																			href="<%=basePath%>/api?servlet=borrow&cmd=prepare_upd&id=<%=borrow.getId()%>"><img
																			width="41" height="20" border="0"
																...
																<td width="65"><div align="center">
																		<a
																			href="<%=basePath%>/api?servlet=borrow&cmd=del&id=<%=borrow.getId()%>"><img
																			width="41" height="20" border="0"
